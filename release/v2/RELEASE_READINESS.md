...
|---|---|---|---|
| 1 | Tournament run count | **PASS — 15 LOCKED** | `bgt_not_admitted.json` locks exactly five arms × seeds `{0,1,2}`, no redistribution, seed-block interleaving, and no 14-run path. Artifact SHA-256: `ec4f76c5997e412f47bb7ef7c083d958ab4857b4a509142698cba6db754fb098`; embedded disposition SHA-256: `35c83b9cc1d135183c2cee5add9d71fb8ac379d19248cd807e25ef06dc102a40`. |
...
| 6 | All-cell no-training preflight | **PASS — 15/15** | `preflight_15_not_admitted/preflight_matrix.json` SHA-256 `0053bd10c04dda759ee0084ccfa758307bb66cc9065b6038da2cc3e408714b00`; all 15 cells pass protocol validation, contain nonempty R1/R2 pins, and carry a real-launcher gate dry-run receipt proving the launcher resolves every allowlisted role (`preflight_manifest`, `config`, `execution_governance`, `code_manifest`, `neff_guard`) at its published path. Full 128-file index SHA-256 `4de4a0079189317038196f812941a43383baf4cdac01c899c49d18ce550b6eb2`, tree SHA-256 `124af63f1a6ea2d7ef35dfa3474b98aeae1125c2d5cdb88d030c610c7f45b24f`. The registry smoke records PREPARING → INITIALIZED → TERMINAL with verified terminal-anchor SHA-256 `3361d3c966e5224cb376e3ba83d066d2bb5ec1a0a7db3730653e0ba65b5180ac`. |
