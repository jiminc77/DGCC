...
def main() -> None:
    ...
    h.append("STEP_LOG 시각 대조상 경합은 악화 요인이나 단독 원인은 아니다. batch-effect는 사전등록 3-way 감도분석 대상이다.")
    h.append("\n## 5. AMD-3 및 F-a")
    h.append("AMD-3: seed 5 페어(BB+V1)를 기술 결함으로 제외하고 대체하지 않는다; BB 평균이 상향되는 방향이므로 V1−BB 델타에는 보수적 방향의 민감도 노트다.")
