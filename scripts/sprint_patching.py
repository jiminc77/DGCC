...
def main() -> int:
    ...
    args.out.write_text(json.dumps({"mode": args.mode, "arm": args.arm, "run_tag": args.run_tag, "probe_files": len(probes), "probe_manifest_sha256": probes.manifest_sha256, "status": "manifest_verified"}, sort_keys=True) + "\n", encoding="utf-8")
    return 0
